...
- **Descripción**: Al acceder al sistema, el nodo deberá notificar a todos los demás componentes del sistema distribuido de este evento.
- **Precondición**
- **Secuencia normal**:
    ...
    5. Se solicita de forma iterativa la creación y configuración de los ficheros y parámetros del usuario a todos los nodos. Comienza el caso de uso CU-2 en cada uno de los nodos
...
- **Secuencia normal**:
    ...
    6. En caso de que el directorio ``/etc/skel`` (o aquel donde se encuentre el directorio esqueleto) contenga una copia del contenedor de servicios *Tomcat*, comienza el caso de uso **CU-3**.
...
- **Secuencia normal**
    ...
    1. El caso de uso comienza como extensión del caso de uso **CU-2**, tras la copia del directorio que contiene la instancia de Tomcat.
